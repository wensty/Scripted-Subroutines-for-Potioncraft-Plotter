...
import { SaltAngle, DeviationT1, EntityPotionEffect, Salt, Effects } from "../main";
...
function beta() {
  ...
  logAddSunSalt(166);
  logSkirt();
  derotateToAngle(10.03, { toAngle: false });
  ...
  console.log(radToDeg(Math.PI + getBottlePolarAngleByEntity(EntityPotionEffect)));
  ...
  heatAndPourToEdge(0.5, 7);
  logAddHeatVortex(3.4); // Empirical
  ...
  logAddPourSolvent(Infinity);
  // section 2
  stirToTurn(3.25, Infinity, 0.1 * SaltAngle); // Empirical
